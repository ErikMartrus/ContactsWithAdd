    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if (segue.identifier == "retornaDone") {
            if (!entradaNombre.text!.isEmpty) {
                nuevoContacto = DatosDeContacto(nombre: entradaNombre.text!, direccion: entradaDireccion.text!, telefono: entradaTelefono.text!, fechaCumple: entradaFechaCumple.date as NSDate)
            }
        }
    }
